 ...
 */
@Entity
@Table(name = "schoolstudentpersonalinformation")
public class SchoolStudentPersonalInformation {
    ...
    public SchoolStudentPersonalInformation() {
    }

    public SchoolStudentPersonalInformation(String registernumber) {
