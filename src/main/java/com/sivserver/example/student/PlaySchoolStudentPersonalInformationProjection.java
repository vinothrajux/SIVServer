 ...
 */
public interface PlaySchoolStudentPersonalInformationProjection {
    ...
    String getReligion();
    String getPickuppersonname();
    String getPickuppersoncontactno();
    String getPickuppersonaltcontactno();
    String getPickuppersonrelationship();
    String getTransport();
